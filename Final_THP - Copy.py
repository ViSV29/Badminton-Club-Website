...
def mainProgram():
    for line in open("data.txt", "r"):
        ...
        if len(line_data) == 4 or len(line_data) == 3: #match has been played or match has been cancelled
...
def buttonQuery(x,y):
    if x < 100 and x > -100 and y < -190 and y > -240:
        ...
        TurtleWrite(150,0)
        turtle.write("Press 1 for The Rankings on a specific date",font=("Times New Roman",20, "bold"),align="left")

        TurtleWrite(150,-60)
        turtle.write("Press 2 for the list of matches a Player has played",font=("Times New Roman",20, "bold"),align="left")

        TurtleWrite(150,-120)
        turtle.write("Press 3 for the Most Active Player",font=("Times New Roman",20, "bold"),align="left")
        
        TurtleWrite(150,-180)
        turtle.write("Press 4 for the Least Active Player",font=("Times New Roman",20, "bold"),align="left")

        TurtleWrite(150,-240)
        turtle.write("Press 5 for Match on a Specific date",font=("Times New Roman",20, "bold"),align="left")

        TurtleWrite(150,-300)
        turtle.write("Press 6 to check Match between Specific players",font=("Times New Roman",20, "bold"),align="left")
        ...
        if option == "1" :
            ...
            while True:
                ...
                try:
                    ...
                    TurtleWrite(0,100)
                    turtle.write("Ranking Update not Available on this Date!",font=("Times New Roman",20),align="center")
            ...
            TurtleWrite(-650,0)
            turtle.write("The most Active Player is" ,font=("Times New Roman",20),align="left")

            TurtleWrite(-650,-20)
            turtle.write(activePlayer ,font=("Times New Roman",20, "bold"),align="left")
            ...
            TurtleWrite(-650,0)
            turtle.write("The least Active Player is" ,font=("Times New Roman",20),align="left")

            TurtleWrite(-650,-20)
            turtle.write(leastPlayer ,font=("Times New Roman",20, "bold"),align="left")

        elif option == "5":
            
            date = turtle.textinput("Date of Match","Please enter the date(dd-mm-yyyy): ")
            ...
            p1 = turtle.textinput("Player 1 Name","Please enter the name of the player : ")
            p2 = turtle.textinput("Player 2 Name","Please enter the name of the player : ")
